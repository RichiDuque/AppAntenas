...
public class AntenaMIMOActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antena_mimoactivity);
        btnAntena = findViewById(R.id.buttonAntenaMimo);
        btnAntena2 = findViewById(R.id.buttonAntenaMimo2);
    ...
    public void loadModels() {
        WeakReference<AntenaMIMOActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.mimo_antena)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AntenaMIMOActivity activity = weakActivity.get();
                    if (activity != null) {
    ...
    public void loadModels2() {
        WeakReference<AntenaMIMOActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.mimo_individual)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
