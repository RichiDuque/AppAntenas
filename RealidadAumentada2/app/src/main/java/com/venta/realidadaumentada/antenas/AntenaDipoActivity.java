...
public class AntenaDipoActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antena_dipo);
        btnAntena = findViewById(R.id.buttonAntenaDipo);
        btnAntena2 = findViewById(R.id.buttonAntenaDipo2);
    ...
    public void loadModels() {
        WeakReference<AntenaDipoActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.dipolo_sin_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AntenaDipoActivity activity = weakActivity.get();
                    if (activity != null) {
    ...
    public void loadModels2() {
        WeakReference<AntenaDipoActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.dipolo_con_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
