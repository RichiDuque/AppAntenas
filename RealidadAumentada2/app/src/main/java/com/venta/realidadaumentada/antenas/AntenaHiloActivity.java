...
public class AntenaHiloActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antena_hilo);
        btnAntena = findViewById(R.id.buttonAntenaHilo);
        btnAntena2 = findViewById(R.id.buttonAntenaHilo2);
    ...
    public void loadModels() {
        WeakReference<AntenaHiloActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.hilo_sin_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AntenaHiloActivity activity = weakActivity.get();
                    if (activity != null) {
    ...
    public void loadModels2() {
        WeakReference<AntenaHiloActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.hilo_con_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
