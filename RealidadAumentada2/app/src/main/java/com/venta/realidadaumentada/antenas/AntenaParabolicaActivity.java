...
public class AntenaParabolicaActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antena_parabolica);
        btnAntena = findViewById(R.id.buttonAntenaParab);
        btnAntena2 = findViewById(R.id.buttonAntenaParab2);
    ...
    public void loadModels() {
        WeakReference<AntenaParabolicaActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.reflector_sin_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AntenaParabolicaActivity activity = weakActivity.get();
                    if (activity != null) {
    ...
    public void loadModels2() {
        WeakReference<AntenaParabolicaActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.reflector_con_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
