...
public class AntenaYagiUdaActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antena_yagi_uda);
        btnAntena = findViewById(R.id.buttonAntenaYagi);
        btnAntena2 = findViewById(R.id.buttonAntenaYagi2);
    ...
    public void loadModels() {
        WeakReference<AntenaYagiUdaActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.yagi_uda_sin_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AntenaYagiUdaActivity activity = weakActivity.get();
                    if (activity != null) {
    ...
    public void loadModels2() {
        WeakReference<AntenaYagiUdaActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, R.raw.yagi_uda_con_texto)
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
